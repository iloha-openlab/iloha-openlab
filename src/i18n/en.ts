export default {
    company: {
        ...
        brandStory: "“ILOHA” is derived from the Japanese concept of Iroha — the fundamentals. We believe that sustainable Open Source and Open Data ecosystems require strong foundations, thoughtful engineering, and long-term commitment. ILOHA Open Lab LLC works at the structural level — not only implementing tools, but strengthening the foundations they depend on.",
        positioning: "ILOHA Open Lab LLC provides professional engineering support for Open Source and Open Data ecosystems. We specialize in translation technology (OmegaT), Geospatial tools(OpenStreetMap), plugin development, and advanced technical training. Based in Japan, collaborating across Europe and APAC.",
        legalForm: "Limited Liability Company(Under registration)",
